...
# Variable a mostrar
variable_mostrar = st.radio("Selecciona variable a mostrar:", ['asegurados', 'trabajadores_asegurados'])
...
# Formato de tabla
format_dict = {"Municipio": lambda x: x}
for col in resultados.columns:
    if col != "Año" and col not in format_dict:
        format_dict[col] = "{:,.0f}"
